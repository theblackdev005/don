...
class FundingDonationActSentAdminMail extends Mailable
{
    use Queueable;
    ...
    {
        return new Envelope(
            subject: $this->mailTrans('mail.donation_act_sent_admin.subject', [
    ...
    {
        return new Content(
            html: 'mail.funding.donation-act-sent-admin',
        );
    }
}
