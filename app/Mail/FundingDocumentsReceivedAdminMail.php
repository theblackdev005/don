...
class FundingDocumentsReceivedAdminMail extends Mailable
{
    use Queueable;
    ...
    {
        return new Envelope(
            subject: $this->mailTrans('mail.documents_received_admin.subject', [
    ...
    {
        return new Content(
            html: 'mail.funding.documents-received-admin',
        );
    }
}
