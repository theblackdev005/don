...
class FundingPreliminarySentAdminMail extends Mailable
{
    use Queueable;
    ...
    {
        return new Envelope(
            subject: $this->mailTrans('mail.preliminary_sent_admin.subject', [
    ...
    {
        return new Content(
            html: 'mail.funding.preliminary-sent-admin',
        );
    }
}
