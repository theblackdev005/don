...
class SiteSettingsController extends Controller
{
    ...
    public function edit(string $locale)
    {
        ...
        return view('admin.settings', [
            ...
            'settings' => [
                ...
                'site_facebook_domain_verification' => (string) config('site.tracking.facebook_domain_verification', ''),
    ...
    public function update(string $locale, Request $request, EnvironmentSettingsService $environmentSettings): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'site_facebook_domain_verification' => ['nullable', 'string', 'max:255'],
        ...
        $updates = [
            ...
            'SITE_FACEBOOK_DOMAIN_VERIFICATION' => trim((string) ($validated['site_facebook_domain_verification'] ?? '')),
        ...
        $environmentSettings->persist($updates, [
            ...
            'site.tracking.facebook_domain_verification' => trim((string) ($validated['site_facebook_domain_verification'] ?? '')),
