...
@include('mail.partials.button-primary', [
  'href' => route('funding-request.documents', ['locale' => $mailLocale, 'public_slug' => $fundingRequest->public_slug]),
...
<p style="margin:0 0 16px;font-size:13px;color:#5c6670;line-height:1.5;">
  ...
  <span style="word-break:break-all;color:#0f6b57;">{{ route('funding-request.documents', ['locale' => $mailLocale, 'public_slug' => $fundingRequest->public_slug]) }}</span>
</p>
