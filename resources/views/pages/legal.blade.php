  ...
  <section class="container pt-5 pb-lg-2 pb-xl-4 py-xxl-5 my-5">
    <nav aria-label="breadcrumb">
      <ol class="pt-lg-3 pb-lg-4 pb-2 breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">{{ __('pages.legal.breadcrumb') }}</li>
      </ol>
    </nav>
    <div class="row pb-1 pb-sm-3 pb-lg-4">
      <div class="col-lg-10 col-xl-8">
        <h1 class="display-5 mb-3">{{ __('pages.legal.heading') }}</h1>
        <p class="fs-lg text-body-secondary mb-4 pb-2">{{ __('pages.legal.intro') }}</p>
        @php
          $site = (string) config('site.name');
          $email = (string) config('site.email');
        @endphp
        <div class="fs-md">
          @foreach(__('pages.legal.sections') as $section)
